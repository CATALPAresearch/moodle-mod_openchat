...
class rate_response_positive_event extends \core\event\base {

    protected function init() {
        $this->data['crud'] = 'w';
        $this->data['edulevel'] = self::LEVEL_PARTICIPATING; 
        $this->data['objecttable'] = 'none';
        $this->data['action'] = 'rate_response_positive';
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' rated a response from a LLM or RAG/LLM positively in the 'openchat activity' with course module id " .
