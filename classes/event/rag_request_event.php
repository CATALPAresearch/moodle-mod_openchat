...
class rag_request_event extends \core\event\base {

    protected function init() {
        $this->data['crud'] = 'c';
        $this->data['edulevel'] = self::LEVEL_PARTICIPATING; 
        $this->data['objecttable'] = 'none';
        $this->data['action'] = 'rag_request';
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' send a request to a RAG/LLM in the 'openchat activity' with course module id " .
