...
require_once($CFG->dirroot . '/mod/openchat/backup/moodle2/backup_openchat_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the Page instance
 */
class backup_openchat_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the openchat.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_openchat_activity_structure_step('openchat_structure', 'openchat.xml'));
    }
